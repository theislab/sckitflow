...
framework generic: it can validate device / solver combinations without knowing
what a velocity field or an ODE solver is. Anything method-specific lives behind
``config_cls``.
"""
