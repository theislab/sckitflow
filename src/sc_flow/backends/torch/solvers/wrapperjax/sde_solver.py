...
from sc_flow.backends.jax.solvers.sde_solver import SDESolver as JaxSDESolver
...
class WrappedSDESolver(BaseSolver[TSDEDynamics]):
    ...
    def solve(
        ...
        *,
        ...
        source_tx = config.source.to("jax")
        ...
        if requires_grad and param_tensors:
            ...
            trajectory, final_state = tsolver_fn(source_tx, *param_tensors)
