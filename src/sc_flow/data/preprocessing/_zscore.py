...
@dataclass
class _ZScoreParams(PreprocessorParams):
...
class ZScorePreprocessor(BasePreprocessor):
    ...
    def __init__(self, epsilon: float = 1e-8) -> None:
        ...
        self._params: _ZScoreParams | None = None

    def fit(self, X: np.ndarray) -> "ZScorePreprocessor":
        ...
        # Store parameters
        self._params = _ZScoreParams(mean=mean, std=std, is_fitted=True, n_features=X.shape[1])
